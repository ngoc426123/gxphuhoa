    ...
    <div class="wrapper">
      <div id="gx-header">
        <div id="headBanner" class="hidden-sm hidden-xs">
          <a href="<?php echo home_url(); ?>"><img src="<?php echo STYLE_DIR ?>/images/banner.jpg" alt=""></a>
        </div>
        ...
        <div id="headMobile">
          ...
          <div class="menuMobile" data-menu-mobile><div class="iconMenu"><div class="styleMenu"></div></div></div>
        </div>
      </div>
      <!--===CONTENT===-->
      <div id="gx-content">